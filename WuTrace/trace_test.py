...
class TestProcessFile(unittest.TestCase):
  ...
  def testTopLevelTransaction(self):
    log = ["1.00100000 TRACE WU START faddr FA0:8:0[VP] wuid 1 name fun_a arg0 1 arg1 2",
...
class EndToEndTest(unittest.TestCase):
  ...
  def testMinimalGraphviz(self):
    log = ['1.001000000 TRACE WU START faddr FA0:8:0[VP] src FA0:8:0[VP] dest FA0:8:0[VP] wuid 1 name fun_a arg0 1 arg1 2',
           '1.00200000  TRACE TRANSACTION START faddr FA0:8:0[VP]',
           '1.00300000 TRACE WU END faddr FA0:8:0[VP] wuid 1 name fun_a arg0 1 arg1 2'
           ]
  ...
  def testMinimalSend(self):
    log = ['1.00100 TRACE WU START faddr FA0:8:0[VP] src FA0:8:0[VP] dest FA0:8:0[VP] wuid 1 name fun_a arg0 1 arg1 2',
