...
class WU(object):
    ...
    def set_trace_src(self, trace_src):
        """
        Sets the source which traced this WU.
...
class NormalWU(WU):
    ...
    def __str__(self):
        ...
        return ('%d: %d %s %s act %s arg0 %s arg1 %s arg2 %s' % (
                self.time, self.trace_src, self.wu_name, path,
