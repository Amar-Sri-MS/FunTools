...
for fname in "$@"; do
        ...
        comby ${args} 'CHANNEL() void :[name](:[params])' 'CHANNEL_HANDLER(:[name], WU_ATTRS_NONE, :[params])' ${fname}
        ...
        comby ${args} 'CHANNEL_THREAD() void :[name](:[params])' 'CHANNEL_THREAD(:[name], WU_ATTRS_NONE, :[params])' ${fname}
        ...
        comby ${args} 'WU_HANDLER() void :[name](:[params])' 'WU_HANDLER(:[name], WU_ATTRS_NONE, :[params])' ${fname}
