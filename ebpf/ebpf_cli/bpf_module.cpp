...
bool bpf_module::__validate(std::unordered_map < std::string,
			    std::string > &params)
{
...
void* bpf_module::__create_request(std::unordered_map<std::string,
		                 std::string>& params) {
...
std::pair<uint8_t*, size_t> bpf_module::create_bin_request(std::unordered_map < std::string, std::string > &params)
{
/*
...
void* bpf_module::create_js_req(std::unordered_map<std::string,
		std::string>& params) {
