...
{'name': u'probe_posthook', 'value': [255, 162, 0, 16, 255, 163, 0, 24, 223, 164, 0, 0, 3, 160, 240, 37, 12, 0, 0, 0, 0, 0, 0, 0, 3, 192, 232, 37, 223, 191, 0, 8, 103, 189, 0, 32, 3, 224, 0, 9]},
...
'relocations': [
  ...
  {'source': {'index': 2, 'kind': 'code', 'name': u'prehook'}, 'type': 4, 'target': {'index': 0, 'kind': 'code', 'name': u'probe'}, 'offset': 52}, {'source': {'index': 1, 'kind': 'code', 'name': u'probe_posthook'}, 'type': 29, 'target': {'index': 2, 'kind': 'code', 'name': u'prehook'}, 'offset': 124}, {'source': {'index': 1, 'kind': 'code', 'name': u'probe_posthook'}, 'type': 28, 'target': {'index': 2, 'kind': 'code', 'name': u'prehook'}, 'offset': 128}, {'source': {'index': 1, 'kind': 'code', 'name': u'probe_posthook'}, 'type': 5, 'target': {'index': 2, 'kind': 'code', 'name': u'prehook'}, 'offset': 136}, {'source': {'index': 1, 'kind': 'code', 'name': u'probe_posthook'}, 'type': 6, 'target': {'index': 2, 'kind': 'code', 'name': u'prehook'}, 'offset': 144}, {'source': {'index': 3, 'kind': 'code', 'name': u'posthook'}, 'type': 4, 'target': {'index': 1, 'kind': 'code', 'name': u'probe_posthook'}, 'offset': 16}]}
