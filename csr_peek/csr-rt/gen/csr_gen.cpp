...
// BEGIN fpg_prs
        ...
        fld_map_t prs_dsp_dfifo_xoff_cnt_thold {
            CREATE_ENTRY("data", 0, 3),
            CREATE_ENTRY("__rsvd", 3, 61)
        };
        auto prs_dsp_dfifo_xoff_cnt_thold_prop = csr_prop_t(
            std::make_shared<csr_s>(prs_dsp_dfifo_xoff_cnt_thold),
            0xA8,
            CSR_TYPE::REG,
            1);
        add_csr(fpg_prs_0, "prs_dsp_dfifo_xoff_cnt_thold", prs_dsp_dfifo_xoff_cnt_thold_prop);
...
// BEGIN fpg_misc
        ...
        fld_map_t fpg_misc_tx_sch_cfg {
            ...
            CREATE_ENTRY("gr_max_positive_credits", 28, 25),
            CREATE_ENTRY("dwrr_wt_eth", 53, 4),
            CREATE_ENTRY("dwrr_wt_flink", 57, 4),
            CREATE_ENTRY("flink_extra_holdoff_en", 61, 1),
...
// BEGIN fcb
        ...
        fld_map_t fcb_gbl_cfg {
            ...
            CREATE_ENTRY("fld_src_impl_data_adj_enable", 12, 1),
            CREATE_ENTRY("fld_src_impl_gnt_dwrr_adj_enable", 13, 1),
            CREATE_ENTRY("fld_ctrl_tx_gbl_adj_enable", 14, 1),
            CREATE_ENTRY("fld_ctrl_tx_fcp_adj_enable", 15, 1),
            CREATE_ENTRY("fld_src_flow_wt_override_enable", 16, 1),
            CREATE_ENTRY("fld_src_flow_wt_mantissa", 17, 4),
            CREATE_ENTRY("fld_src_flow_wt_exponent", 21, 4),
            CREATE_ENTRY("fld_scale_dn_override_enable", 25, 1),
            CREATE_ENTRY("fld_pkt_flush_ignore_psw_xoff", 26, 1),
            CREATE_ENTRY("fld_flow_ctrl_cnt_enable", 27, 1),
            CREATE_ENTRY("fld_scale_dn_cong_thresh", 28, 8),
            CREATE_ENTRY("fld_eqm_flow_wt_updt_disable", 36, 1),
        ...
        fld_map_t fcb_ncv_wu_qid_active_msg_cnt_sta {
            CREATE_ENTRY("fld_cnt", 0, 15),
            CREATE_ENTRY("__rsvd", 15, 49)
        };
        auto fcb_ncv_wu_qid_active_msg_cnt_sta_prop = csr_prop_t(
            std::make_shared<csr_s>(fcb_ncv_wu_qid_active_msg_cnt_sta),
            0x258,
            CSR_TYPE::REG,
            1);
        add_csr(fcb_0, "fcb_ncv_wu_qid_active_msg_cnt_sta", fcb_ncv_wu_qid_active_msg_cnt_sta_prop);
...
// BEGIN nwqm
        ...
        fld_map_t nwqm_cfg {
            CREATE_ENTRY("if2_etp_dly", 0, 4),
            CREATE_ENTRY("if1_etp_dly", 4, 4),
            CREATE_ENTRY("if0_etp_dly", 8, 4),
            CREATE_ENTRY("if2_fep_dly", 12, 4),
            CREATE_ENTRY("if1_fep_dly", 16, 4),
            CREATE_ENTRY("if0_fep_dly", 20, 4),
            CREATE_ENTRY("fae_qid", 24, 14),
            CREATE_ENTRY("nq_drop_wu_crd_inc_ena", 38, 1),
            CREATE_ENTRY("pbuf_max_qid", 39, 15),
...
// BEGIN fae_prs
        ...
        auto prs_dsp_dfifo_xoff_cnt_thold_prop = csr_prop_t(
            ...
            CSR_TYPE::REG,
            1);
        add_csr(fae_prs_0, "prs_dsp_dfifo_xoff_cnt_thold", prs_dsp_dfifo_xoff_cnt_thold_prop);
        fld_map_t prs_intf_cfg {
            CREATE_ENTRY("intf0mode", 0, 2),
            CREATE_ENTRY("__rsvd", 2, 62)
        };
...
// BEGIN etp_prs
        ...
        auto prs_dsp_dfifo_xoff_cnt_thold_prop = csr_prop_t(
            ...
            CSR_TYPE::REG,
            1);
        add_csr(etp_prs_0, "prs_dsp_dfifo_xoff_cnt_thold", prs_dsp_dfifo_xoff_cnt_thold_prop);
        fld_map_t prs_intf_cfg {
            CREATE_ENTRY("intf0mode", 0, 2),
            CREATE_ENTRY("__rsvd", 2, 62)
        };
...
// BEGIN erp_prs
        ...
        auto prs_dsp_dfifo_xoff_cnt_thold_prop = csr_prop_t(
            ...
            CSR_TYPE::REG,
            1);
        add_csr(erp_prs_0, "prs_dsp_dfifo_xoff_cnt_thold", prs_dsp_dfifo_xoff_cnt_thold_prop);
        fld_map_t prs_intf_cfg {
            CREATE_ENTRY("intf0mode", 0, 2),
            CREATE_ENTRY("__rsvd", 2, 62)
        };
...
// BEGIN efp_rfp_lcl
        ...
        fld_map_t efp_rfp_rsrc_alloc_eot {
            CREATE_ENTRY("val", 0, 16),
            CREATE_ENTRY("__rsvd", 16, 48)
        };
        auto efp_rfp_rsrc_alloc_eot_prop = csr_prop_t(
            std::make_shared<csr_s>(efp_rfp_rsrc_alloc_eot),
            0x8C8,
            CSR_TYPE::REG,
            1);
        add_csr(efp_rfp_lcl_0, "efp_rfp_rsrc_alloc_eot", efp_rfp_rsrc_alloc_eot_prop);
        ...
        fld_map_t efp_rfp_err_drop_mask {
            ...
            CREATE_ENTRY("prw_t2xlen_err", 3, 1),
            CREATE_ENTRY("pol_drop", 4, 1),
            CREATE_ENTRY("fwd_drop", 5, 1),
            CREATE_ENTRY("outer_cs_err", 6, 1),
            CREATE_ENTRY("inner_cs_err", 7, 1),
            CREATE_ENTRY("outer_iplen_err", 8, 1),
            CREATE_ENTRY("inner_iplen_err", 9, 1),
            CREATE_ENTRY("fcpea_sec_fail", 10, 1),
            CREATE_ENTRY("fcp_req", 11, 1),
            CREATE_ENTRY("fcp_gnt", 12, 1),
            CREATE_ENTRY("fcp_dummy", 13, 1),
            CREATE_ENTRY("__rsvd", 14, 50)
        };
...
// BEGIN nu_mpg_core
        ...
        fld_map_t nu_mpg_rx_fsm_sta {
            CREATE_ENTRY("desc_raddr", 0, 11),
            CREATE_ENTRY("__rsvd", 11, 53)
        };
        auto nu_mpg_rx_fsm_sta_prop = csr_prop_t(
            std::make_shared<csr_s>(nu_mpg_rx_fsm_sta),
            0xF0,
            CSR_TYPE::REG,
            1);
        add_csr(nu_mpg_core_0, "nu_mpg_rx_fsm_sta", nu_mpg_rx_fsm_sta_prop);
        ...
        fld_map_t nu_mpg_tx_fsm_sta {
            CREATE_ENTRY("desc_raddr", 0, 11),
            CREATE_ENTRY("__rsvd", 11, 53)
        };
        auto nu_mpg_tx_fsm_sta_prop = csr_prop_t(
            std::make_shared<csr_s>(nu_mpg_tx_fsm_sta),
            0x138,
            CSR_TYPE::REG,
            1);
        add_csr(nu_mpg_core_0, "nu_mpg_tx_fsm_sta", nu_mpg_tx_fsm_sta_prop);
...
// END nu_nmg
    ...
    {
// BEGIN nu_fnc
        auto nu_fnc_0 = nu_rng[0].add_an({"nu_fnc"}, 0x15C01000, 4, 0x800000);
