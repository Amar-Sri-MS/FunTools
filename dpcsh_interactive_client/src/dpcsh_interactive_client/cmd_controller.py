...
class CmdController(Cmd):
    def __init__(self, target_ip, target_port, verbose=False):
        Cmd.__init__(self)
        self.prompt = "(dpc_cli) "
        self.dpc_client = DpcClient(server_address=(target_ip,target_port))
    ...
    def disable_port(self, args):
        self._port_cmd_obj.enable_disable_port(
            port_num=args.port_num, shape=args.shape, enable=False
        )

    def enable_port_link_pause(self, args):
        self._port_cmd_obj.enable_disable_link_pause(
            port_num=args.port_num, shape=args.shape
        )
    ...
    def enable_port_tx_link_pause(self, args):
        self._port_cmd_obj.enable_disable_tx_link_pause(
            port_num=args.port_num, shape=args.shape
        )
    ...
    def set_port_pause_quanta(self, args):
        self._port_cmd_obj.port_pause_quanta(
            port_num=args.port_num, shape=args.shape, quanta=args.quanta
        )
    ...
    def set_port_pause_threshold(self, args):
        self._port_cmd_obj.port_pause_threshold(
            port_num=args.port_num, shape=args.shape, threshold=args.threshold
        )
    ...
    def disable_port_pfc(self, args):
        self._port_cmd_obj.enable_disable_pfc(
            port_num=args.port_num, shape=args.shape, enable=False
        )

    def enable_port_tx_pfc(self, args):
        self._port_cmd_obj.enable_disable_tx_pfc(
            port_num=args.port_num, shape=args.shape, class_num=args.class_num
        )
    ...
    def set_port_pfc_quanta(self, args):
        self._port_cmd_obj.port_pfc_quanta(
            port_num=args.port_num,
            shape=args.shape,
            quanta=args.quanta,
            class_num=args.class_num,
    ...
    def set_port_pfc_threshold(self, args):
        self._port_cmd_obj.port_pfc_threshold(
            port_num=args.port_num,
            shape=args.shape,
    ...
    def enable_port_ptp_peer_delay(self, args):
        self._port_cmd_obj.enable_disable_ptp_peer_delay(
            port_num=args.port_num, shape=args.shape
        )
    ...
    def set_port_ptp_peer_delay(self, args):
        self._port_cmd_obj.ptp_peer_delay(
            port_num=args.port_num, shape=args.shape, delay=args.delay
        )
    ...
    def enable_port_ptp_1step(self, args):
        self._port_cmd_obj.enable_disable_ptp_1step(
            port_num=args.port_num, shape=args.shape
        )
    ...
    def set_port_runt_filter(self, args):
        self._port_cmd_obj.set_runt_filter(
            port_num=args.port_num,
            shape=args.shape,
            buffer=args.buffer_64,
            runt_err_en=args.runt_err_en,
            en_delete=args.en_delete,
        )
    ...
    def set_qos_egress_buffer_pool(self, args):
        ...
        self._qos_cmd_obj.egress_buffer_pool(
            sf_thr=sf_thr,
            sx_thr=sx_thr,
            df_thr=df_thr,
            dx_thr=dx_thr,
            ...
            sample_copy_thr=sample_copy_thr,
            nonfcp_thr=nonfcp_thr,
            fcp_xoff_thr=fcp_xoff_thr,
            sf_xoff_thr=sf_xoff_thr,
            sf_xon_thr=sf_xon_thr,
            update_config=True,
        )
    ...
    def set_qos_egress_port_buffer(self, args):
        ...
        self._qos_cmd_obj.egress_port_buffer(
            port_num=port_num, min_thr=min_thr, shared_thr=shared_thr
        )
    ...
    def set_hnu_qos_egress_port_buffer(self, args):
        ...
        shared_thr = args.shared_thr
        self._qos_cmd_obj.egress_port_buffer(
            port_num=port_num, min_thr=min_thr, shared_thr=shared_thr, mode="hnu"
        )
    ...
    def get_hnu_qos_egress_port_buffer(self, args):
        port_num = args.port_num
        self._qos_cmd_obj.egress_port_buffer(
            port_num=port_num, update_config=False, mode="hnu"
        )
    ...
    def set_qos_egress_queue_buffer(self, args):
        ...
        self._qos_cmd_obj.egress_queue_buffer(
            port_num=port_num,
            queue=queue,
            min_thr=min_thr,
            static_shared_thr_green=static_shared_thr_green,
            shared_thr_alpha=shared_thr_alpha,
    ...
    def get_qos_egress_queue_buffer(self, args):
        ...
        queue = args.queue
        self._qos_cmd_obj.egress_queue_buffer(
            port_num=port_num, update_config=False, queue=queue
        )
    ...
    def get_hnu_qos_egress_queue_buffer(self, args):
        ...
        queue = args.queue
        self._qos_cmd_obj.egress_queue_buffer(
            port_num=port_num, update_config=False, queue=queue, mode="hnu"
        )

    def set_qos_egress_priority_map(self, args):
        port_num = args.port_num
        map_list = args.map_list
        self._qos_cmd_obj.egress_queue_to_priority_map(
            port_num=port_num, map_list=map_list, update=True
        )
    ...
    def get_hnu_qos_egress_priority_map(self, args):
        port_num = args.port_num
        self._qos_cmd_obj.egress_queue_to_priority_map(
            port_num=port_num, update=False, mode="hnu"
        )
    ...
    def set_qos_ecn_glb_sh_threshold(self, args):
        ...
        red = args.red
        yellow = args.yellow
        self._qos_cmd_obj.ecn_glb_sh_threshold(
            en=en, green=green, red=red, yellow=yellow, update=True
        )
    ...
    def set_hnu_qos_ecn_glb_sh_threshold(self, args):
        ...
        yellow = args.yellow
        self._qos_cmd_obj.ecn_glb_sh_threshold(
            en=en, green=green, red=red, yellow=yellow, update=True, mode="hnu"
        )
    ...
    def set_qos_ecn_profile(self, args):
        ...
        self._qos_cmd_obj.ecn_profile(
            prof_num=prof_num,
            min_thr=min_thr,
            max_thr=max_thr,
            ecn_prob_index=ecn_prob_index,
            update=True,
        )
    ...
    def set_hnu_qos_ecn_prob(self, args):
        prob_idx = args.prob_idx
        prob = args.prob
        self._qos_cmd_obj.ecn_prob(
            prob=prob, prob_idx=prob_idx, update=True, mode="hnu"
        )
    ...
    def set_qos_wred_profile(self, args):
        ...
        self._qos_cmd_obj.wred_profile(
            prof_num=prof_num,
            min_thr=min_thr,
            max_thr=max_thr,
            wred_prob_index=wred_prob_index,
            update=True,
        )
    ...
    def set_qos_wred_queue_config(self, args):
        ...
        self._qos_cmd_obj.wred_queue_config(
            port_num=port_num,
            queue_num=queue_num,
            wred_en=wred_en,
            wred_weight=wred_weight,
            wred_prof_num=wred_prof_num,
            ecn_en=ecn_en,
            ecn_prof_num=ecn_prof_num,
            update=True,
        )
    ...
    def get_qos_wred_queue_config(self, args):
        ...
        queue_num = args.queue
        self._qos_cmd_obj.wred_queue_config(
            port_num=port_num, queue_num=queue_num, update=False
        )
    ...
    def get_hnu_qos_wred_queue_config(self, args):
        ...
        queue_num = args.queue
        self._qos_cmd_obj.wred_queue_config(
            port_num=port_num, queue_num=queue_num, update=False, mode="hnu"
        )
    ...
    def set_qos_wred_avg_q_config(self, args):
        ...
        self._qos_cmd_obj.wred_avg_q_config(
            q_avg_en=q_avg_en, cap_avg_sz=cap_avg_sz, avg_period=avg_period, update=True
        )
    ...
    def get_hnu_qos_scheduler_config(self, args):
        port_num = args.port_num
        queue = args.queue
        self._qos_cmd_obj.get_scheduler_config(
            port_num=port_num, queue_num=queue, mode="hnu"
        )
    ...
    def set_qos_scheduler_config_dwrr(self, args):
        ...
        queue = args.queue
        weight = args.weight
        self._qos_cmd_obj.scheduler_config_dwrr(
            port_num=port_num, queue_num=queue, weight=weight
        )
    ...
    def set_hnu_qos_scheduler_config_dwrr(self, args):
        ...
        weight = args.weight
        self._qos_cmd_obj.scheduler_config_dwrr(
            port_num=port_num, queue_num=queue, weight=weight, mode="hnu"
        )
    ...
    def set_qos_scheduler_config_shaper(self, args):
        ...
        self._qos_cmd_obj.scheduler_config_shaper(
            port_num=port_num,
            queue_num=queue,
    ...
    def set_qos_scheduler_config_strict_priority(self, args):
        ...
        self._qos_cmd_obj.scheduler_config_strict_priority(
            port_num=port_num,
            queue_num=queue,
    ...
    def set_qos_ingress_pg(self, args):
        ...
        self._qos_cmd_obj.ingress_priority_group(
            port_num=port_num,
            pg_num=pg_num,
            min_thr=min_thr,
            shared_thr=shared_thr,
            shared_xon_thr=shared_xon_thr,
            headroom_thr=headroom_thr,
    ...
    def get_qos_ingress_pg(self, args):
        ...
        pg_num = args.pg
        self._qos_cmd_obj.ingress_priority_group(
            port_num=port_num, pg_num=pg_num, update=False
        )
    ...
    def get_hnu_qos_ingress_pg(self, args):
        ...
        pg_num = args.pg
        self._qos_cmd_obj.ingress_priority_group(
            port_num=port_num, pg_num=pg_num, update=False, mode="hnu"
        )

    def set_qos_ingress_pg_map(self, args):
        port_num = args.port_num
        map_list = args.map_list
        self._qos_cmd_obj.ingress_priority_to_pg_map(
            port_num=port_num, map_list=map_list, update=True
        )
    ...
    def set_hnu_qos_ingress_pg_map(self, args):
        ...
        map_list = args.map_list
        self._qos_cmd_obj.ingress_priority_to_pg_map(
            port_num=port_num, map_list=map_list, update=True, mode="hnu"
        )
    ...
    def set_qos_xoff_status(self, args):
        ...
        pg = args.pg
        status = args.status
        self._qos_cmd_obj.xoff_status(
            port_num=port_num, pg=pg, status=status, update=True
        )
    ...
    def set_hnu_qos_xoff_status(self, args):
        ...
        status = args.status
        self._qos_cmd_obj.xoff_status(
            port_num=port_num, pg=pg, status=status, update=True, mode="hnu"
        )
    ...
    def get_hnu_qos_xoff_status(self, args):
        ...
        pg = args.pg
        self._qos_cmd_obj.xoff_status(
            port_num=port_num, pg=pg, update=False, mode="hnu"
        )
    ...
    def peek_fpg_stats(self, args):
        ...
        self._peek_cmd_obj.peek_fpg_stats(
            port_num=port_num, iterations=iterations, grep_regex=grep_regex
        )
    ...
    def peek_hnu_fpg_stats(self, args):
        ...
        grep_regex = args.grep
        self._peek_cmd_obj.peek_fpg_stats(
            port_num=port_num, grep_regex=grep_regex, mode="hnu"
        )
    ...
    def peek_psw_nu_stats(self, args):
        ...
        iterations = args.iters
        grep_regex = args.grep
        self._peek_cmd_obj.peek_psw_stats(
            mode="nu",
            port_num=port_num,
            queue_list=queues,
    ...
    def peek_meter_stats(self, args):
        ...
        index = args.index
        grep_regex = args.grep
        self._peek_cmd_obj.peek_meter_stats(
            bank=bank, index=index, grep_regex=grep_regex
        )
    ...
    def peek_malloc_caches_slot_stats(self, args):
        ...
        non_coh = args.non_coh
        grep_regex = args.grep
        self._funos_cmd_obj.peek_malloc_caches_slot_stats(
            slot, non_coh, grep_regex=grep_regex
        )
    ...
    def peek_erp_meter_stats(self, args):
        ...
        grep_regex = args.grep
        self._peek_cmd_obj.peek_meter_stats(
            bank=bank, index=index, grep_regex=grep_regex, erp=True
        )
    ...
    def peek_fcp_tunnel_stats(self, args):
        ...
        grep_regex = args.grep
        self._peek_cmd_obj.peek_fcp_tunnel_stats(
            tunnel_id=tunnel_id, grep_regex=grep_regex
        )
    ...
    def peek_fcp_tunnels_stats(self, args):
        tunnel_id = args.tunnel
        path_id = args.path_id
        self._peek_cmd_obj.peek_fcp_stats_tunnel_stats(
            tunnel_id=tunnel_id, path_id=args.path_id
        )
    ...
    def peek_wro_nu_stats(self, args):
        ...
        grep_regex = args.grep
        iterations = args.iters
        self._peek_cmd_obj.peek_wro_stats(
            mode="nu", tunnel_id=tunnel_id, grep_regex=grep_regex, iterations=iterations
        )
    ...
    def peek_wro_hnu_stats(self, args):
        ...
        grep_regex = args.grep
        self._peek_cmd_obj.peek_wro_stats(
            mode="hnu", tunnel_id=tunnel_id, grep_regex=grep_regex
        )
    ...
    def peek_erp_nu_stats(self, args):
        grep_regex = args.grep
        iterations = args.iters
        self._peek_cmd_obj.peek_erp_stats(
            mode="nu", grep_regex=grep_regex, iterations=iterations
        )
    ...
    def peek_etp_nu_stats(self, args):
        grep_regex = args.grep
        iterations = args.iters
        self._peek_cmd_obj.peek_etp_stats(
            mode="nu", grep_regex=grep_regex, iterations=iterations
        )
    ...
    def peek_nu_qos_wred_ecn_stats(self, args):
        ...
        grep_regex = args.grep
        self._peek_cmd_obj.peek_wred_ecn_stats(
            port_num=port_num, queue_num=queue_num, grep_regex=grep_regex
        )

    def peek_nu_sfg_stats(self, args):
        grep_regex = args.grep
        iterations = args.iters
        self._peek_cmd_obj.peek_sfg_stats(
            mode="nu", grep_regex=grep_regex, iterations=iterations, sfg_ext=False
        )
    ...
    def peek_nu_sfg_ext_stats(self, args):
        ...
        iterations = args.iters
        self._peek_cmd_obj.peek_sfg_stats(
            mode="nu", grep_regex=grep_regex, iterations=iterations, sfg_ext=True
        )

    def peek_nu_flowcontrol_stats(self, args):
        grep_regex = args.grep
        iterations = args.iters
        self._peek_cmd_obj.peek_stats_nu_flowcontrol(
    ...
    def peek_per_vp_stats(self, args):
        ...
        if cid_flag and core_id_flag and pp:
            self._peek_cmd_obj.peek_stats_per_vp_pp(
            ...
            self._peek_cmd_obj.peek_stats_per_vp(
                cluster_id=cluster_id,
                core_id=core_id,
                rx=rx,
                tx=tx,
    ...
    def peek_l1_cache_stats(self, args):
        ...
        if core_id and (cluster_id is None):
            print("Please enter value for cluster_id with core_id")
            return self.dpc_client.disconnect()
        self._peek_cmd_obj.peek_stats_l1_cache_pp(
            cluster_id=cluster_id,
            core_id=core_id,
            load=load,
            store=store,
    ...
    def peek_pervppkts_stats(self, args):
        ...
        if cid_flag and core_id_flag:
            self._peek_cmd_obj.peek_pervppkts_stats(
                cluster_id=cluster_id,
                core_id=core_id,
                grep_regex=grep_regex,
                iterations=iterations,
    ...
    def peek_stats_nhp(self, args):
        grep_regex = args.grep
        iterations = args.iters
        self._peek_cmd_obj.peek_nhp_stats(
            grep_regex=grep_regex, iterations=iterations, nhp_ext=False
        )
    ...
    def peek_stats_nhp_ext(self, args):
        ...
        iterations = args.iters
        self._peek_cmd_obj.peek_nhp_stats(
            grep_regex=grep_regex, iterations=iterations, nhp_ext=True
        )
    ...
    def peek_pc_resource_stats(self, args):
        ...
        if core_id and not cluster_id:
            ...
            return self.dpc_client.disconnect()
        if cid_flag and core_id_flag:
            self._peek_cmd_obj.peek_pc_resource_stats(
                cluster_id=cluster_id,
                core_id=core_id,
                grep_regex=grep_regex,
                iterations=iterations,
    ...
    def peek_rgx_resource_stats(self, args):
        grep_regex = args.grep
        cluster_id = args.cluster_id
        self._peek_cmd_obj.peek_rgx_resource_stats(
            cluster_id=cluster_id, grep_regex=grep_regex
        )

    def peek_hnu_resource_stats(self, args):
        grep_regex = args.grep
        resource_id = args.resource_id
        self._peek_cmd_obj.peek_mode_resource_stats(
            mode="hnu", resource_id=resource_id, grep_regex=grep_regex
        )
    ...
    def peek_hu_wqsi_resource_stats(self, args):
        ...
        self._peek_cmd_obj.peek_hu_resource_stats(
            hu_id=id, wqsi=True, resource_id=resource_id, grep_regex=grep_regex
        )
    ...
    def peek_hu_wqse_resource_stats(self, args):
        ...
        grep_regex = args.grep
        self._peek_cmd_obj.peek_hu_resource_stats(
            hu_id=id, wqse=True, grep_regex=grep_regex
        )
    ...
    def peek_hux_resource_stats(self, args):
        ...
        iterations = args.iters
        grep_regex = args.grep
        self._peek_cmd_obj.peek_hux_resource_stats(
            hu_id=id, grep_regex=grep_regex, iterations=iterations
        )
    ...
    def get_nu_configs(self, args):
        ...
        if not config_type in [
            "pool_config",
            "ncv_config",
            "per_pool_flow_control",
            "global_flow_control",
        ]:
            print(
                "Please give config_type in: \n1. pool_config\n2. ncv_config\n3. per_pool_flow_control\n4. global_flow_control"
            )
    ...
    def peek_bam_resource_stats(self, args):
        ...
        diff = args.diff
        iterations = args.iters
        self._peek_cmd_obj.peek_bam_resource_stats(
            cid=cid, diff=diff, grep_regex=grep_regex, iterations=iterations
        )
    ...
    def peek_ocm_resource_stats(self, args):
        ...
        iterations = args.iters
        diff = args.diff
        self._peek_cmd_obj.peek_ocm_resource_stats(
            diff=diff, grep_regex=grep_regex, iterations=iterations
        )
    ...
    def peek_eqm_stats(self, args):
        ...
        grep_regex = args.grep
        iterations = args.iters
        self._peek_cmd_obj.peek_eqm_stats(
            drg_ctx=drg_ctx, evq=evq, grep_regex=grep_regex, iterations=iterations
        )
    ...
    def peek_mud_stats(self, args):
        ...
        iterations = args.iters
        qdepth = args.qd
        self._peek_cmd_obj.peek_stats_mud(
            qdepth=qdepth, iterations=iterations, grep_regex=grep
        )
    ...
    def peek_malloc_caches_stats(self, args):
        grep = args.grep
        iterations = args.iters
        self._peek_cmd_obj.peek_stats_malloc_caches(
            iterations=iterations, grep_regex=grep
        )
    ...
    def peek_tcp_flows_details(self, args):
        ...
        dest = args.dest
        iterations = args.iters
        self._peek_cmd_obj.peek_tcp_flows_details(
            count=count, dest=dest, iterations=iterations
        )
    ...
    def peek_tcp_flows_state_filter(self, args):
        ...
        count = args.count
        flow_id = args.flow_id
        self._peek_cmd_obj.peek_tcp_flows_state(
            flow_id=flow_id, sip=sip, dip=dip, sport=sport, dport=dport, count=count
        )
    ...
    def peek_tcp_flows_fc_filter(self, args):
        ...
        count = args.count
        flow_id = args.flow_id
        self._peek_cmd_obj.peek_tcp_flows_fc(
            flow_id=flow_id, sip=sip, dip=dip, sport=sport, dport=dport, count=count
        )
    ...
    def peek_stats_rate_all(self, args):
        ...
        count = args.count
        iterations = args.iters
        self._peek_cmd_obj.peek_tcp_flows_stats(
            count=count, rate=rate, iterations=iterations
        )
    ...
    def peek_probetest_pathinfo(self, args):
        ...
        status = args.status
        pathinfo = True
        self._peek_cmd_obj.peek_stats_probetest(
            pathinfo=pathinfo, path_id=path_id, status=status
        )
    ...
    def set_probetest_setpath(self, args):
        ...
        state = args.state
        status = args.status
        self._peek_cmd_obj.set_nu_probetest(
            setpath=setpath, path_index=path_index, state=state, status=status
        )
    ...
    def set_probetest_nacktrigger(self, args):
        ...
        path_index = args.path_index
        self._peek_cmd_obj.set_nu_probetest(
            nacktrigger=nacktrigger, path_index=path_index
        )
    ...
    def set_probetest_setuppath(self, args):
        ...
        self._peek_cmd_obj.set_nu_probetest(
            setuppath=setuppath, path_index=path_index, inner_dip=inner_dip
        )
    ...
    def peek_rdsock_stats(self, args):
        grep = args.grep
        iterations = args.iters
        self._peek_cmd_obj.peek_rdsock_flow_stats(
            grep_regex=grep, iterations=iterations
        )
    ...
    def peek_hu_pcie_stats(self, args):
        ...
        grep_regex = args.grep
        iterations = args.iters
        self._peek_cmd_obj.peek_stats_hu_pcie(
            hu_id=hu_id, grep_regex=grep_regex, iterations=iterations
        )
    ...
    def peek_hu_fc_stats(self, args):
        ...
        grep_regex = args.grep
        iterations = args.iters
        self._peek_cmd_obj.peek_stats_hu_fc(
            hu_id=hu_id, grep_regex=grep_regex, iterations=iterations
        )
    ...
    def peek_hu_link_stats(self, args):
        ...
        grep_regex = args.grep
        iterations = args.iters
        self._peek_cmd_obj.peek_stats_hu_link(
            hu_id=hu_id, grep_regex=grep_regex, iterations=iterations
        )
    ...
    def peek_hu_pwp_stats(self, args):
        ...
        grep_regex = args.grep
        iterations = args.iters
        self._peek_cmd_obj.peek_stats_hu_pwp(
            hu_id=hu_id, grep_regex=grep_regex, iterations=iterations
        )
    ...
    def clear_nu_port_stats(self, args):
        self._clear_cmd_obj.clear_nu_port_stats(
            port_num=args.port_num, shape=args.shape
        )
    ...
    def set_sample(self, args, mode):
        ...
        self._sample_cmd_obj.set_sample(
            id=id,
            fpg=fpg,
            dest=dest,
            acl=acl,
            ...
            psw_drop=psw_drop,
            pps_en=pps_en,
            pps_interval=pps_interval,
            pps_burst=pps_burst,
            pps_tick=pps_tick,
            sampler_en=sampler_en,
            sampler_rate=sampler_rate,
            sampler_run_sz=sampler_run_sz,
    ...
    def show_tech_nu_stats(self, args):
        ...
        self._show_cmd_obj.show_stats(
            filename=filename,
            mode="nu",
            port_list=portlist,
            fcp_tunnel_id=fcp_tunnel_id,
        )
    ...
    def get_flow_list(self, args):
        ...
        if pp:
            if hcf_id and (("." not in hcf_id) or len(hcf_id.split(".")) != 3):
                print(
                    "Please enter hcf_id(hu.cntrl.fnid) in x.x.x format. Current given %s"
                    % hcf_id
                )
                return self.dpc_client.disconnect()
                ...
                return self.dpc_client.disconnect()
            self._flow_cmd_obj.get_flow_list_pp(
                hcf_id=hcf_id,
                hu_id=hu_id,
                tx=tx,
                rx=rx,
            ...
            self._flow_cmd_obj.get_flow_list(
                hcf_id=hcf_id, hu_id=hu_id, grep_regex=grep_regex
            )
    ...
    def flow_list_rdma(self, args):
        ...
        hu_id = args.hu_id
        qpn_number = args.qpn
        self._flow_cmd_obj.get_flow_list_rdma(
            hu_id=hu_id, qpn_number=qpn_number, grep_regex=grep_regex
        )
    ...
    def peek_stats_rdma(self, args):
        ...
        hu_id = args.hu_id
        qpn_number = args.qpn
        self._peek_cmd_obj.peek_stats_rdma(
            hu_id=hu_id, qpn_number=qpn_number, grep_regex=grep_regex
        )
    ...
    def debug_vp_util(self, args):
        ...
        if core_id and (cluster_id is None):
            ...
            return self.dpc_client.disconnect()
        if cid_flag and core_id_flag and pp:
            self._debug_cmd_obj.debug_vp_util_pp(
                cluster_id=cluster_id, core_id=core_id, grep_regex=grep_regex
            )
        elif cid_flag and core_id_flag:
            self._debug_cmd_obj.debug_vp_util(
                cluster_id=cluster_id, core_id=core_id, grep_regex=grep_regex
            )
    ...
    def storage_list_vols(self, args):
        ...
        if voltype == "blt":
            self._storage_obj.storage_list_volumes_blt(
                voltype="VOL_TYPE_BLK_LOCAL_THIN"
            )
        elif voltype == "lsv":
            ...
            self._storage_obj.storage_list_volumes_replica(
                voltype="VOL_TYPE_BLK_REPLICA"
            )
        elif voltype == "nvmem":
    ...
    def storage_vol_stats(self, args):
        ...
        voltype = args.voltype
        if voltype == "blt":
            self._storage_obj.storage_volume_stats(
                vol_uuid, voltype="VOL_TYPE_BLK_LOCAL_THIN"
            )
        elif voltype == "lsv":
            ...
            self._storage_obj.storage_volume_stats(
                vol_uuid, voltype="VOL_TYPE_BLK_FILE"
            )
        elif voltype == "ec":
            self._storage_obj.storage_volume_stats(vol_uuid, voltype="VOL_TYPE_BLK_EC")
        elif voltype == "replica":
            self._storage_obj.storage_volume_stats(
                vol_uuid, voltype="VOL_TYPE_BLK_REPLICA"
            )
        elif voltype == "memvol":
            self._storage_obj.storage_volume_stats(
                vol_uuid, voltype="VOL_TYPE_BLK_MEMORY"
            )
        elif voltype == "sdk_memvol":
            self._storage_obj.storage_volume_stats(
                vol_uuid, voltype="VOL_TYPE_SDK_BLK_MEMORY"
            )
        else:
            print("Unknown voltype")
    ...
    set_port_ptp_peer_delay_disable_parser.set_defaults(
        func=disable_port_ptp_peer_delay
    )
    ...
    set_qos_scheduler_strict_priority_parser.set_defaults(
        func=set_qos_scheduler_config_strict_priority
    )
    ...
    # -------------- QoS Command Handlers ----------------
    set_hnu_qos_egress_buffer_pool_parser.set_defaults(
        func=set_hnu_qos_egress_buffer_pool
    )
    get_hnu_qos_egress_buffer_pool_parser.set_defaults(
        func=get_hnu_qos_egress_buffer_pool
    )
    set_hnu_qos_egress_port_buffer_parser.set_defaults(
        func=set_hnu_qos_egress_port_buffer
    )
    get_hnu_qos_egress_port_buffer_parser.set_defaults(
        func=get_hnu_qos_egress_port_buffer
    )
    set_hnu_qos_egress_queue_buffer_parser.set_defaults(
        func=set_hnu_qos_egress_queue_buffer
    )
    get_hnu_qos_egress_queue_buffer_parser.set_defaults(
        func=get_hnu_qos_egress_queue_buffer
    )
    set_hnu_qos_egress_priority_map_parser.set_defaults(
        func=set_hnu_qos_egress_priority_map
    )
    get_hnu_qos_egress_priority_map_parser.set_defaults(
        func=get_hnu_qos_egress_priority_map
    )
    get_hnu_qos_ecn_glb_sh_thresh_parser.set_defaults(
        func=get_hnu_qos_ecn_glb_sh_threshold
    )
    set_hnu_qos_ecn_glb_sh_thresh_parser.set_defaults(
        func=set_hnu_qos_ecn_glb_sh_threshold
    )
    ...
    set_hnu_qos_wred_avg_queue_config_parser.set_defaults(
        func=set_hnu_qos_wred_avg_q_config
    )
    get_hnu_qos_wred_avg_queue_config_parser.set_defaults(
        func=get_hnu_qos_wred_avg_q_config
    )
    set_hnu_qos_wred_queue_config_parser.set_defaults(
        func=set_hnu_qos_wred_queue_config
    )
    get_hnu_qos_wred_queue_config_parser.set_defaults(
        func=get_hnu_qos_wred_queue_config
    )
    get_hnu_qos_scheduler_config_parser.set_defaults(func=get_hnu_qos_scheduler_config)
    set_hnu_qos_scheduler_dwrr_parser.set_defaults(
        func=set_hnu_qos_scheduler_config_dwrr
    )
    set_hnu_qos_scheduler_shaper_parser.set_defaults(
        func=set_hnu_qos_scheduler_config_shaper
    )
    set_hnu_qos_scheduler_strict_priority_parser.set_defaults(
        func=set_hnu_qos_scheduler_config_strict_priority
    )
    ...
    peek_malloc_agent_non_coh_stats_parser.set_defaults(
        func=peek_malloc_agent_non_coh_stats
    )
    ...
    peek_stats_tcp_flows_state_filter_sub_parser.set_defaults(
        func=peek_tcp_flows_state_filter
    )
    ...
    peek_stats_tcp_flows_fc_filter_sub_parser.set_defaults(
        func=peek_tcp_flows_fc_filter
    )
