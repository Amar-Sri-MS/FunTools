...
class CmdController(Cmd):
    ...
    def peek_sdnflow_stats(self, args):
        offset = args.offset
        num_flows = args.num_flows
        print offset, num_flows
        self._peek_cmd_obj.peek_sdnflow_stats(offset=offset, num_flows=num_flows)
    ...
    peek_stats_sdnflow_parser.set_defaults(func=peek_sdnflow_stats)
